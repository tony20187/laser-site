...
const machines = [
  { id: 1, name: "AMADA 雷射機台介紹", image: "./9000w-1.png" },
  { id: 2, name: "AMADA ASFH 自動倉儲系統介紹", image: "./03_ENSISASFH_transparent (1).png" },
];
...
function MachineIntro() {
  ...
  const handleMouseEnter = (machine) => playSpeech(machine.name);
