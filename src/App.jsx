  ...
  return (
    <HashRouter>
      <Routes>
        ...
        <Route path="/AnalysisIntro/machineview" element={<MachineView />} />
        <Route path="/AnalysisIntro/StorageView" element={<StorageView />} />
        <Route path="/AnalysisIntro" element={<AnalysisIntro />} />
      </Routes>
    </HashRouter>
  );
}
